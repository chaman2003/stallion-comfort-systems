      ...
      <div className="container mx-auto px-4 mb-16">
        ...
        <div className="max-w-4xl">
          <p className="text-xl text-gray-700 mb-8">
            For over three decades, we have been at the forefront of innovative
            furniture design, combining traditional craftsmanship with modern
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 bg-gray-50 rounded-lg">
            ...
            <p className="text-gray-600">
              We maintain the highest standards of quality in every piece we
              create, combining traditional techniques with modern innovation.
            </p>
          </div>
          <div className="p-8 bg-gray-50 rounded-lg">
            <h3 className="text-xl font-medium mb-4">Sustainability</h3>
            <p className="text-gray-600">
              Our commitment to environmental responsibility guides every aspect
