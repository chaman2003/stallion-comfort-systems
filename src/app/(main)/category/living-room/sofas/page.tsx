  ...
  const sofaTypes = [
    {
      ...
      slug: "straight",
      description:
        "Classic straight sofas with stainless steel frame and premium upholstery",
    },
    {
      name: "Corner Sofas",
      image: "bg-gray-200",
      slug: "corner",
      description:
        "Space-efficient corner sofas for maximizing seating capacity",
    },
    {
      name: "Curved Sofas",
      image: "bg-gray-200",
    ...
    },
    {
      ...
      slug: "recliner",
      description:
        "Premium recliners with stainless steel mechanisms for ultimate comfort",
    },
    {
      name: "Sofa Cum Bed",
      image: "bg-gray-200",
    ...
    <div className="min-h-screen pt-32 pb-16">
      ...
      <div className="container mx-auto px-4 mb-12">
        ...
        <p className="text-gray-600 max-w-3xl">
          Our signature sofa collection features stainless steel frames combined
          with premium upholstery materials. Each sofa is designed for
          exceptional comfort, durability, and aesthetic appeal.
        </p>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-2xl md:text-3xl font-serif mb-4">
                Stainless Steel Frame Technology
              </h2>
              <p className="text-gray-600 mb-6">
                Our proprietary stainless steel frame construction offers
                unmatched durability and visual lightness. Unlike conventional
                wood frames, our frames will never warp, crack, or lose
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center">
                  <div className="w-2 h-2 rounded-full bg-gold mr-2"></div>
                  <span className="text-gray-700">
                    Precision-engineered joints and supports
                  </span>
                </li>
              </ul>
            </div>
      ...
      <div className="container mx-auto px-4 mb-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {sofaTypes.map((sofaType, index) => (
            ...
            >
              <Link
                href={`/category/living-room/sofas/${sofaType.slug}`}
                className="block"
              >
                <div className="overflow-hidden rounded-lg shadow-md">
                  <div
                    className={`h-48 ${sofaType.image} flex items-center justify-center`}
                  >
                    <span className="text-xl text-gray-500">
                      Image Placeholder
                    </span>
