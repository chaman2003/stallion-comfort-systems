  ...
  const subcategories = [
    {
      ...
      slug: "sofas",
      description:
        "Premium stainless steel sofas for ultimate comfort and elegance",
    },
    {
      name: "Pouffe",
      image: "bg-gray-200",
    ...
    <div className="min-h-screen pt-32 pb-16">
      ...
      <div className="container mx-auto px-4 mb-12">
        ...
        <p className="text-gray-600 max-w-3xl">
          Discover our premium living room furniture, featuring stainless steel
          craftsmanship combined with comfort and style. Transform your living
          spaces with our innovative designs that blend durability with
          elegance.
        </p>
      </div>
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="w-full h-80 bg-gray-200 rounded-xl flex items-center justify-center">
          <span className="text-xl text-gray-500">
            Featured Living Room Collection Image
          </span>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 mb-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {subcategories.map((subcategory, index) => (
            ...
            >
              <Link
                href={`/category/living-room/${subcategory.slug}`}
                className="block"
              >
      ...
      <div className="container mx-auto px-4 mb-16 bg-gray-50 py-12 rounded-xl">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-serif mb-6 text-center">
            Our Living Room Design Philosophy
          </h2>
          <p className="text-gray-600 mb-8 text-center">
            At Stallion Stainless, our living room furniture seamlessly blends
            innovative design with timeless craftsmanship. Each piece is
            meticulously crafted using premium stainless steel for durability
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Combining modern aesthetics with practical functionality
              </p>
            </div>
            <div className="text-center">
              <div className="rounded-full bg-gold/10 w-16 h-16 mx-auto flex items-center justify-center mb-4">
              ...
              <p className="text-sm text-gray-600">
                304 grade stainless steel with precision welding and polishing
              </p>
            </div>
            <div className="text-center">
              <div className="rounded-full bg-gold/10 w-16 h-16 mx-auto flex items-center justify-center mb-4">
              ...
              <p className="text-sm text-gray-600">
                Tailor-made options to match your exact requirements
              </p>
            </div>
          </div>
        </div>
