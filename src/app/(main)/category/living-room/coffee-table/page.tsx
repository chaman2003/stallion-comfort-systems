  ...
  const subcategories = [
    {
      ...
      image: "bg-gray-200",
      slug: "round-table",
      description: "Elegant round coffee tables with premium stainless steel base"
    },
    {
      name: "Square Tables",
      image: "bg-gray-200",
    ...
    },
    {
      ...
      description: "Sophisticated rectangular coffee tables for spacious living rooms"
    },
    {
      name: "Shaped Tables",
      image: "bg-gray-200",
  ...
  return (
    <div className="min-h-screen pt-32 pb-16">
      ...
      <div className="container mx-auto px-4 mb-12">
        <h1 className="text-3xl md:text-4xl font-serif mb-4">Premium Coffee Tables</h1>
        <p className="text-gray-600 max-w-3xl">
          Our coffee tables blend innovative stainless steel construction with premium materials like glass, 
          marble, and wood. Each piece is designed to be both a functional centerpiece and a work of art.
        </p>
      </div>
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="w-full h-80 bg-gray-200 rounded-xl flex items-center justify-center relative overflow-hidden">
          <span className="text-xl text-gray-500">Featured Coffee Table Collection Image</span>
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
          <div className="absolute bottom-0 left-0 p-8 text-white">
            <h2 className="text-3xl font-serif mb-2">Architectural Coffee Tables</h2>
            <p className="mb-4 max-w-xl">
              Our signature collection featuring sculptural stainless steel bases and premium tops.
              Each piece is a statement of modern elegance.
            </p>
            <Link
      ...
      {/* Subcategories Grid */}
      <div className="container mx-auto px-4 mb-16">
        <h2 className="text-2xl md:text-3xl font-serif mb-8">Browse Coffee Table Styles</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {subcategories.map((subcategory, index) => (
            <motion.div
              ...
              className="group"
            >
              <Link href={`/category/living-room/coffee-table/${subcategory.slug}`} className="block">
      ...
      <div className="container mx-auto px-4 mb-16 bg-gray-50 py-12 rounded-xl">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-serif mb-6 text-center">Premium Materials</h2>
          <p className="text-gray-600 mb-10 text-center">
            Our coffee tables feature only the finest materials, selected for both beauty and longevity.
          </p>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">304 and 316 grade stainless steel with mirror or brushed finishes</p>
            </div>
            <div className="text-center">
              <div className="rounded-full bg-gold/10 w-16 h-16 mx-auto flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-sm text-gray-600">Italian marble, tempered glass, and solid hardwood tops</p>
            </div>
            <div className="text-center">
              <div className="rounded-full bg-gold/10 w-16 h-16 mx-auto flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-sm text-gray-600">Meticulously crafted joints and connections for lasting durability</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="border border-gray-200 rounded-xl p-8 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-2/3 mb-6 md:mb-0">
            ...
            <p className="text-gray-600">
              Learn how to maintain the beauty of your stainless steel coffee table for decades to come.
              Our comprehensive care guide covers cleaning, protection, and maintenance tips.
            </p>
          </div>
          <Link 
            href="/materials" 
