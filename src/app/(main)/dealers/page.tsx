...
import { dealers, partnershipBenefits } from "@/lib/data";
      ...
      <div className="container mx-auto px-4 mb-16">
        ...
        <div className="max-w-4xl">
          <p className="text-xl text-gray-700 mb-8">
            Our network of authorized dealers represents the finest furniture
            retailers across the country. Each dealer is carefully selected to
            ensure they meet our high standards of service and expertise.
          </p>
        </div>
      </div>
