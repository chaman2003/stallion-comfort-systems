    ...
    <div className="min-h-screen pt-32 pb-20">
      ...
      <div className="container mx-auto px-4 mb-12">
        <div className="flex items-center space-x-2 text-sm text-gray-500">
          <Link
            href="/"
            className="hover:text-[hsl(var(--theme))] transition-colors"
          >
            Home
          </Link>
          <span>/</span>
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-10">
            At Stallion, we believe that luxury and sustainability can go hand
            in hand. Our commitment to sustainable practices is at the core of
            everything we do, from responsible material sourcing to eco-friendly
          ...
          <div>
            ...
            <div className="space-y-10">
              {sustainabilityGoals.map((goal, index) => (
                ...
                >
                  <div className="mr-6">
                    <div className="text-3xl font-serif text-[hsl(var(--theme))]">
                      {goal.year}
                    </div>
                  </div>
                  <div>
          ...
          <div>
            <div className="mb-10">
              ...
              <p className="text-gray-600">
                For complementary materials, we select eco-friendly options like
                responsibly-sourced wood, organic textiles, and water-based
                finishes that minimize environmental impact without compromising
                on quality.
              </p>
            </div>
            ...
            <div className="mt-10">
              ...
              <p className="text-gray-600">
                Each piece of Stallion furniture is designed with longevity in
                mind – creating products that last for generations is one of the
                most sustainable practices we can embrace.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4">
        <div className="bg-gray-100 rounded-lg p-8 md:p-12 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Learn more about our sustainability initiatives and how you can be
            part of our journey towards a more sustainable future.
          </p>
          <Link
            href="/contact"
