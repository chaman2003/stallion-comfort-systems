  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-40 flex flex-col items-center justify-center bg-black/50 text-white text-center px-4">
        ...
        >
          <h1
            className="text-4xl md:text-5xl lg:text-6xl tracking-wide font-serif mb-2 text-shadow-lg"
            style={{
          ...
          <p
            className="text-lg md:text-xl tracking-wider mb-8 text-gray-200 text-shadow"
            style={{
          ...
          <Link href="/category/living-room">
            <button
              className="bg-white text-[#001F3F] px-8 py-3 rounded-none hover:bg-[#001F3F] hover:text-white transition-colors text-lg tracking-wider"
              style={{
                fontFamily: "'Montserrat', sans-serif",
                fontWeight: 500,
              }}
